          ...
          <div className="space-y-4">
            {contributions.map((c, i) => (
              <motion.a
                ...
                whileHover={{ x: 5 }}
                className="glass rounded-xl p-5 flex items-start gap-4 hover:border-primary/30 transition-all group"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    ...
                    <span className="text-xs px-2 py-0.5 bg-primary/5 text-primary-light rounded">
                      {c.type}
                    </span>
                  </div>
